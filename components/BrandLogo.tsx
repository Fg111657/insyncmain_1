...
export default function BrandLogo({
  ...
  // ── Mark (inline SVG) ──────────────────────────────────────────────────────
  // Paths traced from the vectorized New Logo V2 (FreeSample-Vectorizer-io-insynclogo.svg).
  // viewBox "315 515 490 545" frames the 4 mark elements in the original 2592×1685 space.
  //
  // MAINTENANCE: if the logo mark ever changes, update the paths here
  // AND in all /public/brand/logo*.svg files. See docs/logo-system.md.
  const mark = (
    <svg
    ...
    >
      ...
      {/* Arc / J-curve connecting body to arm */}
