 ...
 * (Moustafa pending — will be added when photo sourced from ZocDoc.)
 * Clean white cards, no 3D effects.
 */
...
export default function TeamSection({ compact = false, hideHeader = false }: TeamSectionProps) {
